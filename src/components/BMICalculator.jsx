...
const BMICalculator = () => {
  ...
  const calculateBMI = (e)=>{
    ...
    if(bmiValue < 18.5){
      ...
      toast.success(
        'You have noraml weight. Keep maintaing a healthy lifestyle.'
      );
    }
      ...
      toast.error(
        'You are in obese range. It is recommended to seek an advice from a healthcare specialist.'
      );
    }
